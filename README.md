# ✨ Criador Mágico de Animações com IA: Seu Designer de CSS Pessoal! ✨
...
Para que a mágica aconteça, este projeto depende de um **webhook (`http://localhost:5678/webhook/animacao-css`)** que interage com uma ferramenta de automação (N8N). Isso significa que ele precisa de uma conexão ativa com a internet e que o backend esteja funcionando para gerar as animações.
